...
export default function ConvocatoriaPage() {
  ...
  const ofertaEducativa = ["Ingeniería en Tecnologías de la Información y Comunicaciones (TIC's)"]

  const modalidades = {
    escolarizada: ["Ingeniería en Tecnologías de la Información y Comunicaciones (TIC's)"],
    mixta: ["Ingeniería en Tecnologías de la Información y Comunicaciones (TIC's)"],
  }
          ...
          <Card>
            ...
            <CardContent className="p-6">
              ...
              <div className="bg-blue-50 p-4 rounded-md mb-6">
                <Link href="/aspirantes/oferta-educativa" className="block">
                  <p className="font-medium text-blue-800 hover:text-blue-600 transition-colors flex items-center">
                    {ofertaEducativa[0]}
          ...
          <div className="bg-blue-50 p-6 rounded-lg">
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-medium">$628.00 MXN</span>
              </div>
              <div className="flex justify-between">
                <span>Inscripción:</span>
                <span className="font-medium">$1,420.00 MXN</span>
              </div>
              <div className="flex justify-between">
                <span>Colegiatura semestral:</span>
                <span className="font-medium">$1,827.00 MXN</span>
              </div>
            </div>
