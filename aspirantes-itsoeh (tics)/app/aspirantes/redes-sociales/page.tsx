  ...
  const redesSociales = [
    {
      id: "facebook",
      nombre: "Facebook",
      usuario: "@ITIC.ITSOEHmx",
      url: "https://www.facebook.com/ITIC.ITSOEHmx?locale=es_LA",
    ...
    },
    {
      id: "instagram",
      nombre: "Instagram",
      usuario: "@itics.itsoeh",
      url: "https://www.instagram.com/itics.itsoeh/",
    ...
    },
    {
      ...
      icono: (
        <Image
          src="https://www.addlance.com/blog/wp-content/uploads/2021/10/tiktok-logo.png"
          alt="TikTok"
          width={32}
          height={32}
